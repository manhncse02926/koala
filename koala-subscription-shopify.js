...
function KLHistory(t) {
    ...
    function renderFormHorizontal(p){
        ...
        <div  title="Topbar" frameborder="0" scrolling="no" allowtransparency="true" style="background: transparent; border: 0px; width: 100%; height: 80px; z-index: 18000; margin-bottom: 0px; margin-top: 0px;">
